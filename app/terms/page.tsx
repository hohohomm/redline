...
RedLine is a SaaS application that helps small service businesses send automated invoice follow-up emails to their clients. The Service is operated from New South Wales, Australia and is available at redlineinvoices.com.
...
You are responsible for keeping your login credentials secure. You must notify us immediately at support@redlineinvoices.com if you suspect unauthorised access to your account. We are not liable for losses caused by unauthorised access where you failed to keep your credentials secure.

Each account may only be used by one person or business entity. Sharing accounts across multiple organisations is not permitted.


4. FREE TRIAL

New accounts receive a 7-day free trial. No credit card is required to start a trial. At the end of the trial period your account will move to the selected paid plan or to a free tier (if available). We reserve the right to modify or end trial offers at any time.
...
- Use the Service to send unsolicited bulk email (spam) or to harass, threaten, or deceive any person.
...
We may suspend or terminate your account immediately if we believe you are in breach of these terms.


6. AUTOMATED FOLLOW-UPS

The Service sends automated reminder emails to your invoice recipients on your behalf. You are solely responsible for:
...
If you believe you have been charged in error, contact us within 14 days at support@redlineinvoices.com and we will investigate.
...
- We will retain your data for 30 days after termination, during which time you may export it.
...
- Cloudflare (DNS, CDN, and security) — cloudflare.com
